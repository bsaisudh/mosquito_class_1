...
parser.add_argument("-e","--epochs",default=500,type=int,help="Num. of epochs for training")
parser.add_argument("-d","--datafolder",default="./Datasets/i_TrainVal",type=str,help="Specify the training data folder")
...
l = len(image_datasets)
dataset_sizes = [l//5, l//5, l//5, l//5, l//5]
training_set = torch.utils.data.random_split(image_datasets,dataset_sizes)
